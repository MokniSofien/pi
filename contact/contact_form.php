...
<!-- header-->
<div id="PageHeader1" >
<div id="PageHeader1_Container" style="width:1091px;position:relative;margin-left:auto;margin-right:auto;text-align:left;overflow:auto;">
<div id="wb_Image1" >
...
<div id="wb_Image2" >
<img src="images/recheche.png" id="Image2" alt=""></div>
<div id="wb_Image3">
...
<!-- login --> <li>
<a  href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block';changeFrame('../connexion/');"><img src="images/admin.png" id="Image3" alt=""></a></li>
