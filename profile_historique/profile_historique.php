...
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> Prix</span></td>
<td class="cell2"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> Quantité</span></td>
</tr>
<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> Version Basic</span></td>
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $data['basictotale'];?> $</span></td>
<td class="cell2"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo $data['basicqt'];?></span></td>
</tr>
<tr>
<td class="cell3"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> Version Business </span></td>
<td class="cell4"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $data['businesstotale'];?>$</span></td>
<td class="cell5"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $data['businessqt'];?></span></td>
</tr>
<tr>
<td class="cell6"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> Version Entreprise </span></td>
<td class="cell7"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo $data['entreprisetotale'];?>$</span></td>
<td class="cell8"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $data['entrepriseqt'];?></span></td>
</tr>
</table>
 <?php }?>
...
<span style="color:#F7F7F9;font-family:Arial;font-size:17px;"><strong><a href="../profile/index.php?id=<?php echo $ligne['id'];?>">Profil</a></strong></span></div>
...
<span style="color:#4eb1cb;font-family:Arial;font-size:19px;">consulter votre historique d’achat&nbsp; </span></div>
</div>
